...
const EnterKey = '↵';
const MaxTries = 6;
const DistinctCharacterPattern = /^(?:([a-z])(?!.*\1))*$/;
...
describe('Cheatle', () => {
    ...
    function removeLetterFromAll(letter) {
        possibleCharacters.forEach((pattern, index) => {
            possibleCharacters[index] = pattern.replace(letter, '');
        });
    }

    function setLetterAsFound(letter, index) {
        possibleCharacters[index] = letter;
    }
